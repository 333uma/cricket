...
public class PlayerH2Service implements PlayerRepository{
    ...
    public Player addPlayer(Player player){
        ...
        Player p = db.query("select * from team where playerName = ? and jerseyNumber = ? and role = ?",new PlayerRowMapper(), player.getPlayerName(), player.getJerseyNumber(), playergetRole());
        return p;
    }
    @Override
